        ...
        <tbody>
          ...
          <tr>
            ...
            <td
              class="border-t-0 px-6 align-middle border-l-0 border-r-0 text-xs whitespace-no-wrap p-4"
            >
              <i class="fas fa-circle text-green-500 mr-2" />
              completed
            </td>
            <td
              class="border-t-0 px-6 align-middle border-l-0 border-r-0 text-xs whitespace-no-wrap p-4"
  ...
  props: {
    ...
    data: {
      ...
      {  
        birthday: '03/02/2000',
        mssv: '102170210',
        email: 'nguyentrungdodo@gmail.com',
        name: 'Nguyễn Trung Đô',
        phone: '0905911371'
      },
       {  
        birthday: '04/06/1999',
        mssv: '102170211',
        email: 'nguyenviettantan@gmail.com',
        name: 'Nguyễn Việt Tân',
        phone: '0905768204'
      },
       {  
        birthday: '06/04/1999',
        mssv: '102170212',
        email: 'trunghieunguyen@gmail.com',
